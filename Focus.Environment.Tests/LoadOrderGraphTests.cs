...
public class LoadOrderGraphTests
{
    class Plugins
    {
        ...
        public static readonly PluginInfo Dawnguard =
            new("Dawnguard.esm", new[] { "Skyrim.esm", "Update.esm" });
        public static readonly PluginInfo HearthFires =
            new("HearthFires.esm", new[] { "Skyrim.esm", "Update.esm" });
        public static readonly PluginInfo Dragonborn =
            new("Dragonborn.esm", new[] { "Skyrim.esm", "Update.esm" });
        public static readonly PluginInfo UnofficialPatch =
            new(
                "USSEP.esm",
                new[]
                {
        ...
        public static readonly PluginInfo VanillaBasedMod =
            new("VanillaQuest.esp", new[] { "Skyrim.esm" });
        public static readonly PluginInfo UnofficialPatchBasedMod =
            new(
                "USSEPQuest.esp",
                new[]
                {
        ...
        public static readonly PluginInfo PatchForVanillaBasedModAndUnofficialPatchBasedMod =
            new(
        ...
        public static readonly PluginInfo PluginWithUndeclaredMasters =
            new("Undeclared.esp", new[] { "USSEPQuest.esp" });
    }
    ...
    public class Healthy
    {
        ...
        public Healthy()
        {
            graph = new(
                new PluginInfo[]
                {
                    ...
                    Plugins.PatchForVanillaBasedModAndUnofficialPatchBasedMod with
                    {
                        IsEnabled = false,
                    },
                },
        ...
        public void GetAllMasters_ReturnsDeclaredMasters()
        {
            ...
            Assert.Equal(
                new[] { "Skyrim.esm", "Update.esm" },
                graph.GetAllMasters("Dawnguard.esm")
            );
            Assert.Equal(
                new[] { "Skyrim.esm", "Update.esm" },
                graph.GetAllMasters("HearthFires.esm")
            );
            Assert.Equal(
                new[] { "Skyrim.esm", "Update.esm" },
                graph.GetAllMasters("Dragonborn.esm")
            );
            Assert.Equal(
                new[]
                {
    ...
    public class WithMissingPlugin
    {
        ...
        public void GetMissingMasters_ReturnsDisabledMasters()
        {
            ...
            Assert.Equal(Enumerable.Empty<string>(), graph.GetMissingMasters("VanillaQuest.esp"));
            Assert.Equal(
                new[] { "Dragonborn.esm", "USSEP.esm" },
                graph.GetMissingMasters("USSEPQuest.esp")
            );
            Assert.Equal(
