    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        var log = Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.File(
                ...
                outputTemplate: "{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} [{ThreadId:D2}] [{Level:u3}] "
        ...
        log.Information(
            ...
            AssemblyProperties.Name,
            AssemblyProperties.Version,
            AssemblyProperties.BuildTimestampUtc
        );
