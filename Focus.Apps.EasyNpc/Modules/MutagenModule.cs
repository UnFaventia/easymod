...
public class MutagenModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder
            .Register(ctx =>
                GameInstance.FromGameId(ctx.Resolve<IGameLocations>(), GameId, DataDirectory)
            )
            .AsSelf()
            .As<GameSelection>();
        ...
        builder
            .RegisterType<GameEnvironmentWrapper<ISkyrimMod, ISkyrimModGetter>>()
            .As<IMutableGameEnvironment<ISkyrimMod, ISkyrimModGetter>>()
            .As<IReadOnlyGameEnvironment<ISkyrimModGetter>>()
            .OnActivated(NotifyAfterGameSetup)
            .SingleInstance();
        builder
            .RegisterType<GameSettings<ISkyrimModGetter>>()
            .As<IGameSettings>()
            .OnActivated(NotifyAfterGameSetup)
            .SingleInstance();
