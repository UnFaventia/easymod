...
public class Settings : IAppSettings, IMutableAppSettings, IObservableAppSettings
{
    ...
    public string BuildReportPath { get; set; } =
        Path.Combine(ProgramData.DirectoryPath, "BuildReport.json");
    ...
    public IReadOnlyList<RecordKey> RaceTransformationKeys { get; set; } =
        new List<RecordKey>
        {
    ...
    public IObservable<IReadOnlyList<MugshotRedirect>> MugshotRedirectsObservable =>
        mugshotRedirects;
    ...
    IEnumerable<BuildWarningSuppression> IAppSettings.BuildWarningWhitelist =>
        BuildWarningWhitelist;
    ...
    private static List<MugshotRedirect> GetDefaultMugshotRedirects()
    {
        return new()
        {
            ...
            new MugshotRedirect { ModName = "Fresh Faces", Mugshots = "Fresh Faces - SSE" },
            new MugshotRedirect
            {
