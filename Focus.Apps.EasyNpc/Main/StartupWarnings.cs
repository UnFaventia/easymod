...
{
    public static readonly StartupWarning MissingVortexManifest =
        new()
        {
    ...
    public static StartupWarning InvalidCommandLine(IEnumerable<string> errorMessages) =>
        new()
        {
    ...
    public static StartupWarning MissingGameData(string gameId, string gameName) =>
        new()
        {
    ...
    public static StartupWarning UnsupportedGame(string gameId, string gameName) =>
        new()
        {
...
public class MissingGameDataContent
{
    ...
    public string IssuesUrl { get; private init; } =
        "https://github.com/focustense/easymod/labels/gamefinder";
    public string SupportedDistributionsUrl { get; private init; } =
        "https://github.com/erri120/GameFinder#gamefinder";
