...
public class NpcSummaryRow : IRecordKey
{
    ...
    public NpcSummaryRow(INpc npc)
    {
        ...
        Name = npc.Name;
        Filter = npc.HasAvailableFaceCustomizations
            ? NpcSummaryFilter.Modded
            : NpcSummaryFilter.Unmodded;
...
public class NpcSummaryViewModel
{
    ...
    )
    {
        ...
        rows = profile
            .Npcs.Concat(profile.Hidden.Npcs)
