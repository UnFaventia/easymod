...
public class OutputViewModel
{
    ...
    )
    {
        ...
        BuildSettings = Observable.CombineLatest(
            modSettings.RootDirectoryObservable,
            modName,
            enableArchiving,
            enableDewiggify,
            texturePathExtractionTimeoutSec,
            GetBuildSettings
        );
        BuildSettings.SubscribeSafe(
            log,
            settings =>
            {
    ...
    private BuildSettings GetBuildSettings(
        ...
        bool enableDewiggify,
        int texturePathExtractionTimeoutSec
    )
    {
