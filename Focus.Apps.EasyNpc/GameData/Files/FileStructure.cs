...
{
    public static readonly IReadOnlyList<string> DlcPluginNames = new[]
    {
        "Update.esm",
        "Dawnguard.esm",
        "HearthFires.esm",
    ...
    public static readonly string FaceMeshesPath = Path.Combine(
        "meshes",
        "actors",
        "character",
        "facegendata",
    ...
    public static readonly string FaceTintsPath = Path.Combine(
        "textures",
        "actors",
        "character",
        "facegendata",
    ...
    private static readonly HashSet<string> dlcPluginSet =
        new(DlcPluginNames, StringComparer.OrdinalIgnoreCase);
