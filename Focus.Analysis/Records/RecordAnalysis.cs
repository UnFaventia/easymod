...
public abstract class RecordAnalysis : IRecordKey
{
    ...
    public IReadOnlyList<ReferencePath> InvalidPaths { get; init; } =
        Empty.ReadOnlyList<ReferencePath>();
    ...
    public IReadOnlyList<AssetReference> ReferencedAssets { get; init; } =
        Empty.ReadOnlyList<AssetReference>();
}
...
public class ReferencePath
{
    public IReadOnlyList<ReferenceInfo> References { get; init; } =
        Empty.ReadOnlyList<ReferenceInfo>();
