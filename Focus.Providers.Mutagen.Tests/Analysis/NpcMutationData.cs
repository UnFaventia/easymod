...
class NpcMutations
{
    ...
    public static readonly NpcMutationData Behavior =
        new(
            new Action<Npc>[]
            {
                ...
                x =>
                    x.Destructible = new()
                    {
                        Stages = { new() { Model = new() { File = "destruct1.nif" } } },
                    },
                ...
                x =>
                    ...
                    {
                        Types = { new() { Type = NpcSoundType.SoundType.LeftFoot } },
                    },
    ...
    public static readonly NpcMutationData Face =
        new(
            new Action<Npc>[]
            {
    ...
    public static readonly NpcMutationData Ignored =
        new(
            new Action<Npc>[]
            {
    ...
    public static readonly NpcMutationData Outfits =
        new(
            new Action<Npc>[]
            {
    ...
    public static readonly NpcMutationData Scales =
        new(new Action<Npc>[] { x => x.Height += 0.04f, x => x.Weight += 7 });
    ...
    public static readonly NpcMutationData Unused =
        new(
            new Action<Npc>[]
            {
                x => x.AIData.Unused++,
    ...
    {
        return Enum.GetValues<TEnum>().Where(v => !Equals(v, currentValue)).FirstOrDefault();
    }
}
