...
public class GroupCacheTests
{
    ...
    public void GetAll_ReturnsRecordsFromAllPluginsInPriorityOrder()
    {
        ...
        mod1.Shouts.Add(
            new Shout(FormKey.Factory("000001:mod1.esp"), release) { EditorID = "Mod1Record1" }
        );
        mod1.Shouts.Add(
            new Shout(FormKey.Factory("000002:mod1.esp"), release) { EditorID = "Mod1Record2" }
        );
        var mod2 = AddLoadedMod("mod2.esp");
        mod2.Shouts.Add(
            new Shout(FormKey.Factory("000001:mod1.esp"), release) { EditorID = "Mod2Record1" }
        );
        mod2.Shouts.Add(
            new Shout(FormKey.Factory("000002:mod2.esp"), release) { EditorID = "Mod2Record2" }
        );
        var mod3 = AddLoadedMod("mod3.esp");
        mod3.Shouts.Add(
            new Shout(FormKey.Factory("000001:mod1.esp"), release) { EditorID = "Mod3Record1" }
        );
        mod3.Shouts.Add(
            new Shout(FormKey.Factory("000002:mod1.esp"), release) { EditorID = "Mod3Record2" }
        );
        mod3.Shouts.Add(
            new Shout(FormKey.Factory("000002:mod2.esp"), release) { EditorID = "Mod3Record3" }
        );
    ...
    public void GetWinner_ReturnsWinningOverride()
    {
        ...
        var mod1 = AddLoadedMod("mod1.esp");
        mod1.Shouts.Add(
            new Shout(FormKey.Factory("000001:mod1.esp"), release) { EditorID = "Mod1Record" }
        );
        var mod2 = AddLoadedMod("mod2.esp");
        mod2.Shouts.Add(
            new Shout(FormKey.Factory("000001:mod1.esp"), release) { EditorID = "Mod2Record" }
        );
        mod2.Shouts.Add(
            new Shout(FormKey.Factory("000002:mod2.esp"), release) { EditorID = "DummyRecord" }
        );
        var mod3 = AddLoadedMod("mod3.esp");
        mod3.Shouts.Add(
            new Shout(FormKey.Factory("000001:mod1.esp"), release) { EditorID = "Mod3Record" }
        );
    ...
    private ISkyrimMod AddLoadedMod(string fileName, InvocationTracker<ISkyrimMod>? tracker = null)
    {
        ...
        var proxiedMod = new ProxyGenerator().CreateInterfaceProxyWithTarget<ISkyrimMod>(
            mod,
