...
public class NpcAnalyzerTests : CommonAnalyzerFacts<NpcAnalyzer, Npc, NpcAnalysis>
{
    ...
    {
        Analyzer = new NpcAnalyzer(
            Groups,
            armorAddonHelperMock.Object,
            ReferenceChecker.Of<INpcGetter>()
        );
    }
    ...
    public void MergesRaceWithFemaleNpcHeadParts()
    {
        var vanillaHeadPartKeys = Groups.AddRecords<HeadPart>(
            ...
            x =>
            {
                x.EditorID = "VanillaFace";
                x.Type = HeadPart.TypeEnum.Face;
            },
            x =>
            {
                x.EditorID = "VanillaEyes";
                x.Type = HeadPart.TypeEnum.Eyes;
            },
            x =>
            {
                x.EditorID = "VanillaHair";
                x.Type = HeadPart.TypeEnum.Hair;
            },
            x =>
            {
                x.EditorID = "VanillaFacialHair";
                x.Type = HeadPart.TypeEnum.FacialHair;
            }
        );
        var raceKeys = Groups.AddRecords<Race>(
            "vanilla.esp",
            r => r.HeadData = CreateHeadData(vanillaHeadPartKeys.ToFormKeys(), true)
        );
        var moddedHeadPartKeys = Groups.AddRecords<HeadPart>(
            "mod.esp",
            x =>
            {
                x.EditorID = "ModdedFace";
                x.Type = HeadPart.TypeEnum.Face;
            },
            x =>
            {
                x.EditorID = "ModdedHair";
                x.Type = HeadPart.TypeEnum.Hair;
            }
        );
    ...
    public void MergesRaceWithMaleNpcHeadParts()
    {
        ...
        var raceKeys = Groups.AddRecords<Race>(
            "vanilla.esp",
            r => r.HeadData = CreateHeadData(vanillaHeadPartKeys.ToFormKeys(), false)
        );
        var moddedHeadPartKeys = Groups.AddRecords<HeadPart>(
            "mod.esp",
            x =>
            ...
            {
                x.EditorID = "Scar1";
                x.Type = HeadPart.TypeEnum.Scars;
            },
            x =>
            {
                x.EditorID = "Scar2";
    ...
    public void WhenConfigIncludesFemaleFlag_IsFemale_IsTrue()
    {
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
            x => x.Configuration.Flags |= NpcConfiguration.Flag.Female
        );
        var analysis = Analyzer.Analyze("plugin.esp", npcKeys[0]);
    ...
    public void WhenConfigIncludesUseTemplateFlag_IsAudioTemplate_IsTrue()
    {
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
            x => x.Configuration.Flags |= NpcConfiguration.Flag.UseTemplate
        );
        var analysis = Analyzer.Analyze("plugin.esp", npcKeys[0]);
    ...
    public void WhenRaceInvalid_CanUseFaceGen_IsFalse()
    {
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
            x => x.Race.SetTo(FormKey.Factory("123456:plugin.esp"))
        );
        var analysis = Analyzer.Analyze("plugin.esp", npcKeys[0]);
    ...
    public void WhenRaceExcludesFaceGenFlag_CanUseFaceGen_IsFalse()
    {
        ...
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
            x => x.Race.SetTo(raceKeys[0].ToFormKey())
        );
        var analysis = Analyzer.Analyze("plugin.esp", npcKeys[0]);
    ...
    public void WhenNpcHasWig_AndNoHairInHeadParts_WigInfo_IsBald()
    {
        var headPartKeys = Groups.AddRecords<HeadPart>(
            ...
            {
                x.Type = HeadPart.TypeEnum.Face;
                x.Model = new() { File = "face.nif" };
            },
            x =>
            {
                x.Type = HeadPart.TypeEnum.Eyes;
                x.Model = new() { File = "eyes.nif" };
            }
        );
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
    ...
    public void WhenNpcHasWig_AndWinningHairHasNoModel_WigInfo_IsBald()
    {
        ...
        var raceKeys = Groups.AddRecords<Race>(
            "plugin.esp",
            x => x.HeadData = CreateHeadData(headPartKeys.Take(1).ToFormKeys(), false)
        );
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
            x =>
    ...
    public void WhenNpcHasWig_AndWinningHairHasModel_WigInfo_IsNotBald()
    {
        ...
        var raceKeys = Groups.AddRecords<Race>(
            "plugin.esp",
            x => x.HeadData = CreateHeadData(headPartKeys.ToFormKeys(), false)
        );
        var npcKeys = Groups.AddRecords<Npc>(
            "plugin.esp",
            x =>
        ...
        Groups.AddRecords<Npc>(
            ...
            x =>
                SetupNpcForComparison(
                    ...
                    npc =>
                    {
                        var hairKeys = Groups.AddRecords<HeadPart>(
                            "plugin.esp",
                            x =>
                            {
    ...
    [InlineData(
        false,
        SkinTestChange.ModdedNpcRace /* race with default skin */
    )]
    [InlineData(
        false,
        SkinTestChange.OriginalNpcSkin,
        SkinTestChange.ModdedNpcRace,
        SkinTestChange.ModdedNpcRaceSkin
    )]
    [InlineData(
        false,
        SkinTestChange.OriginalNpcSkin,
        SkinTestChange.ModdedNpcRace,
        SkinTestChange.ModdedNpcSkin
    )]
            ...
            x =>
                SetupNpcForComparison(
                    ...
                    npc =>
                    {
                        ...
                        {
                            var newRaceKeys = Groups.AddRecords<Race>(
                                "plugin.esp",
                                r =>
                                    r.Skin.SetTo(
    ...
    public void WhenCustomSkinSpecified_OverridesDefaultRaceSkin()
    {
        ...
        var npcKeys = Groups.AddRecords<Npc>(
            ...
            npc =>
            {
                var raceKeys = Groups.AddRecords<Race>(
                    "plugin.esp",
                    race => race.Skin.SetTo(raceSkinKey)
                );
                npc.Race.SetTo(raceKeys[0].ToFormKey());
    ...
    public void WhenIgnoredAttributesModified_AllComparisonsExceptIdentical_AreEqual(
        Action<Npc> mutation
    )
    {
        var npcKeys = Groups.AddRecords<Npc>("master.esp", SetupNpcForComparison);
    ...
    public void ProvidesComparisonsForAllMasters_InListingOrder()
    {
        ...
        Groups.ConfigureMod(
            ...
            modMock =>
            {
                ...
                modHeaderMock
                    .SetupGet(x => x.MasterReferences)
                    .Returns(
                        new ExtendedList<MasterReference>(
                            new[]
                            {
        ...
        where T : class, ISkyrimMajorRecord
    {
        return Groups
            .AddRecords(
                pluginName,
                editorIds.Select(id => (Action<T>)((T x) => x.EditorID = id)).ToArray()
            )
            .ToFormKeys()
            .ToList()
            .AsReadOnly();
    ...
    private void AssertComparisons(
        ...
        string masterPluginName,
        string previousOverridePluginName,
    ...
    private static HeadData CreateHeadData(IEnumerable<FormKey> headPartKeys)
    {
        ...
        var headPartRefs = headPartKeys.Select(
            (x, i) =>
            {
    ...
    private void SetupNpcComparisonDependencies()
    {
        ...
        comparisonDependencies = new()
        {
            ...
            FactionRanks = AddEmptyRecords<Faction>(
                    pluginName,
                    "JarlFaction",
                    "VampireFaction",
            ...
            HeadPartKeys = Groups
                .AddRecords<HeadPart>(
                    ...
                    x =>
                    {
                        x.EditorID = "FemaleEyesHumanBlue";
                        x.Type = HeadPart.TypeEnum.Eyes;
                    },
                    x =>
                    {
                        x.EditorID = "HairFemaleNord5";
                        x.Type = HeadPart.TypeEnum.Hair;
                    },
                    x =>
                    {
                        x.EditorID = "BrowsFemaleHuman2";
                        x.Type = HeadPart.TypeEnum.Eyebrows;
                    }
                )
                .ToFormKeys()
            ...
            ItemEntries = AddEmptyRecords<MiscItem>(pluginName, "Basket", "Health Potion", "Gold")
                ...
                .Select(x => new ContainerEntry
                {
                    ...
                    {
                        Item = x.First.ToLink<IMiscItemGetter>(),
                        Count = x.Second,
                    },
                })
                .ToList()
            ...
            PackageKeys = AddEmptyRecords<Package>(
                pluginName,
                "WatfordWork",
                "DefaultSandbox",
                "Eat",
            ...
            PerkPlacements = AddEmptyRecords<Perk>(
                    pluginName,
                    "MagicResistance30",
                    "Recovery30",
                    "Regeneration"
                ...
                .Zip(new byte[] { 2, 3, 1 })
                .Select(x => new PerkPlacement
                {
                    Perk = x.First.ToLink<IPerkGetter>(),
                    Rank = x.Second,
                })
                .ToList()
                .AsReadOnly(),
                            ...
                            CreateHeadData(
                                Groups
                                    .AddRecords<HeadPart>(
                                        ...
                                        x =>
                                        {
                                            x.EditorID = "MaleHeadNord";
                                            x.Type = HeadPart.TypeEnum.Face;
                                        },
                                        x =>
                                        {
                                            x.EditorID = "MaleEyesHumanBrown";
                                            x.Type = HeadPart.TypeEnum.Eyes;
                                        },
                                        x =>
                                        {
                                            x.EditorID = "HairMaleNord1";
                                            x.Type = HeadPart.TypeEnum.Hair;
                                        },
                                        x =>
                                        {
                                            x.EditorID = "BrowsMaleHuman1";
                                            x.Type = HeadPart.TypeEnum.Eyebrows;
                                        }
                                    )
                                    .ToFormKeys()
                            ...
                            CreateHeadData(
                                Groups
                                    .AddRecords<HeadPart>(
                                        ...
                                        x =>
                                        {
                                            x.EditorID = "FemaleHeadNord";
                                            x.Type = HeadPart.TypeEnum.Face;
                                        },
                                        x =>
                                        {
                                            x.EditorID = "FemaleEyesHumanBrown";
                                            x.Type = HeadPart.TypeEnum.Eyes;
                                        },
                                        x =>
                                        {
                                            x.EditorID = "HairFemaleNord1";
                                            x.Type = HeadPart.TypeEnum.Hair;
                                        },
                                        x =>
                                        {
                                            x.EditorID = "BrowsFemaleHuman1";
                                            x.Type = HeadPart.TypeEnum.Eyebrows;
                                        }
                                    )
                                    .ToFormKeys()
        ...
        npc.TintLayers.AddRange(
            new[]
            {
                new TintLayer
                {
                    ...
                    InterpolationValue = 0.3f,
                },
                new TintLayer
                {
                    Index = 27,
                    Color = Color.Indigo,
                    InterpolationValue = 0.67f,
                },
                new TintLayer
                {
                    Index = 28,
                    Color = Color.Pink,
                    InterpolationValue = 0.89f,
                },
                new TintLayer
                {
                    Index = 29,
    ...
    private void SetupWigScenario(FormKey? raceKey, Npc npc, params WigSetting[] addonConfigs)
    {
        ...
        IEnumerable<FormKey> CreateAddons()
        {
            ...
            {
                var addonKeys = Groups.AddRecords<ArmorAddon>(
                    "plugin.esp",
                    x =>
                    {
