...
public class ReferenceCheckerTests
{
    ...
    {
        checker = new ReferenceChecker<INpcGetter>(groups).Configure(f =>
            follower = f.Follow(x => x.Class)
                ...
                .Follow(
                    x => x.Race,
                    race =>
                        race.Follow(x => x.DefaultHairColors)
                            .Follow(
                                x => x.Skin,
                                skin =>
                                    skin.Follow(
            ...
            .AddRecords<Race>(
                ...
                x =>
                {
                    ...
                    x.DefaultHairColors = new GenderedItem<IFormLinkGetter<IColorRecordGetter>>(
                        ...
                        AddRecord<ColorRecord>("DefaultFemaleHairColor")
                    ...
                    x.Skin = groups
                        .AddRecords<Armor>(
                            ...
                            a =>
                            {
                                ...
                                a.Armature.AddRange(
                                    groups
                                        .AddRecords<ArmorAddon>(
                                            "main.esp",
                                            d =>
                                            {
                                                d.EditorID = "BodyAddon";
                                                d.AdditionalRaces.AddRange(
                                                    AddRecords<Race>("AddRace1", "AddRace2")
                                                );
                                            },
                                            d =>
                                            {
                                                ...
                                                var femaleModel = new Model
                                                {
                                                    AlternateTextures = new(
                                                        new[]
                                                        {
                                                            ...
                                                            {
                                                                NewTexture = AddRecord<TextureSet>(
                                                                        "Feet1"
                                                                    )
    ...
    public void WhenReferencesInvalid_YieldsInvalidPaths()
    {
        ...
        var headPartKeys = groups
            .AddRecords<HeadPart>(
                ...
                x =>
                {
                        ...
                        groups
                            .AddRecords<HeadPart>(
                                ...
                                hp =>
                                {
                                    ...
                                    hp.Color.SetTo(AddRecord<ColorRecord>("HairlineColor"));
                                    hp.TextureSet.SetTo(
                                        FormKey.Factory("123456:badhairlinetextureset.esp")
                                    );
                                }
                            )
                            .ToFormKeys()
                    ...
                    x.ExtraParts.Add(
                        FormKey.Factory("123456:badheadpart.esp").ToLink<IHeadPartGetter>()
                    );
                    x.TextureSet.SetTo(AddRecord<TextureSet>("HairTextureSet"));
                },
                x =>
                {
                    x.EditorID = "Face";
                    x.Color.SetTo(
                        FormKey.Factory("123456:badfacecolor.esp").ToLink<IColorRecordGetter>()
                    );
                }
            )
            .ToFormKeys()
                                    ...
                                    groups
                                        .AddRecords<ArmorAddon>(
                                            ...
                                            d =>
                                            {
                                                ...
                                                d.AdditionalRaces.Add(
                                                    FormKey.Factory("123456:badadditionalrace.esp")
                                                );
                                            },
                                            d =>
                                            {
        ...
        Assert.Collection(
            ...
            x =>
                AssertPath(
                    x,
                    PathFrom(npc).Id("Hair").Key("123456:badheadpart.esp", RecordType.HeadPart)
                ),
            x =>
                AssertPath(
                    x,
                    PathFrom(npc).Id("Face").Key("123456:badfacecolor.esp", RecordType.Color)
                ),
            x =>
                AssertPath(
                    x,
    ...
    public void WhenPluginsExcluded_SkipsExcludedRecords()
    {
        ...
        Assert.Collection(
            ...
            x =>
                AssertPath(
                    x,
                    PathFrom(npc).Id("Face").Key("123456:badheadpart.esp", RecordType.HeadPart)
                )
        );
    }
        ...
        var headPartKeys = groups
            .AddRecords<HeadPart>(
                ...
                x =>
                {
                    ...
                    x.ExtraParts.Add(x.FormKey.ToLinkGetter<IHeadPartGetter>());
                    x.ExtraParts.Add(
                        FormKey.Factory("123456:badheadpart.esp").ToLink<IHeadPartGetter>()
                    );
                    x.TextureSet.SetTo(AddRecord<TextureSet>("HairTextureSet"));
        ...
        where T : class, ISkyrimMajorRecord
    {
        foreach (var editorId in editorIds)
            yield return groups
                .AddRecords<T>("main.esp", x => x.EditorID = editorId)
                .Single()
                .ToFormKey();
    }
    ...
    class PathAssertionBuilder
    {
        ...
        public PathAssertionBuilder Id(string editorId)
        {
            ...
            References.Add(
                new ReferenceInfo(key.ToRecordKey(), getterType.GetRecordType(), editorId)
            );
            return this;
        }
